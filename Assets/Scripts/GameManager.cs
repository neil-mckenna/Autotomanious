...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField] private bool isAlertActive = false;
    ...
    {
        if (HUDAlertTimeText != null)
        {
            int minutes = Mathf.FloorToInt(totalAlertTime / 60);
            int seconds = Mathf.FloorToInt(totalAlertTime % 60);
            HUDAlertTimeText.text = $"Alert Time: {minutes:00}:{seconds:00}";
        }
    }
    ...
    public void GuardAlerted()
    {
        ...
        {
            isAlertActive = true;
            currentAlertStartTime = Time.time;
            Debug.Log("isAlertActive set to TRUE"); // ADD THIS
        }
    ...
    public void GuardLostPlayer()
    {
        ...
        {
            isAlertActive = false;
            Debug.Log($"GuardLostPlayer called - isAlertActive set to FALSE"); // ADD THIS
        }
    }
